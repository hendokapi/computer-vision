...
if __name__ == "__main__":
    ...
    # Adjusted paths for Google Drive (saving is disabled as per user request)
    # DRIVE_OUTPUT_DIR = '/content/drive/My Drive/colab_output/session2'
    # Path(DRIVE_OUTPUT_DIR).mkdir(parents=True, exist_ok=True)
    # MODEL_SAVE_PATH = os.path.join(DRIVE_OUTPUT_DIR, "baseline_model.h5")
    # RESULTS_DIR = os.path.join(DRIVE_OUTPUT_DIR, "baseline_results")
...
")
    ...
    # with open(os.path.join(RESULTS_DIR, "baseline_classification_report.txt"), "w") as f:
...
")
    ...
    print(report)
    # print(f"Saved to {os.path.join(RESULTS_DIR, 'baseline_classification_report.txt')}")

    # 8. Save the trained model
    # print(f"Saving baseline model to {MODEL_SAVE_PATH}...")
    # model.save(MODEL_SAVE_PATH)
    print("Model saving is disabled as per user request.")
    ...
    plt.tight_layout()
    plt.show()
    # print(f"Training history plot saved to {os.path.join(RESULTS_DIR, 'baseline_training_history.png')}")
